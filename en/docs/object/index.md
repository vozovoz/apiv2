...
| [Delivery dates](schedule.md)  | `schedule`    | `get`             | An object that returns the available shipping (dispatch) and delivery (destination) dates                                                                                                 |
| [Direct query](directQuery.md) | `directQuery` | `get`             | To support older methods, there is a direct query object that allows you to send a query directly to database                                                                             |
