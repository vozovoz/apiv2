...
|-------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Required          |
| `location`        | string        | Unique internal ID of a location, or a query string to search for                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `terminal`        | string        | Unique internal ID of a terminal, or set value to `"default"`, which replaces value with a default terminal ID for a specified location                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Optional          |   
